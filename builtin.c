 ...
 * @info: Structure containing the potential arguments. Used to the maintain
 ...
 * constant this is the function prototype.
 * Return: Always reads 0
 */
...
/**
 * _myhelp - this elps changes the current directory of the process
