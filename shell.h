...
/* Shows the environment where the shell runs on */
...
/* Prints asa string in the standar output */
...
/* Duplicates aan string */
char *str_duplicate(char *string);

/* Compares two of the strings */
