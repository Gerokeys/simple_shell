...
/**
 * builtin_cd - change the directory we are in
 ...
 * @data: struct for the program's data
 * @new_dir: path to be set as the working from directory
 * Return: zero if sucess, or other number if its declared in the arguments
 */
...
/**
 * builtin_help - shows the environment where the shell runs on
...
/**
 * builtin_alias - add, remove or show all of the aliases
 * @data: struct for the program's data
 * Return: zero if sucess, or other number if its declared in one of the arguments
 */
