...
/**
* Getlines - read one line from the prompts.
* @data: struct for the program's data
*
* Return: reading of te counting bytes.
*/
...
* @array_operators: array of he logical operators for each previous command
*
* Return: index of the last of the command in the array_commands.
*/
