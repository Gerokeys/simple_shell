...
/**
 * modify_alias - add, remove or show aliases on the function
 ...
 * @name: name of ze requested alias.
 * Return: zeroo if sucess, or other number if its declared in the arguments
 */
 ...
 * @alias_string: alias to be seet in the form (name='value')
 * @data: struct for the program's information
